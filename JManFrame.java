...
public class JManFrame extends JFrame {
    ...
    private void addInstructions(Box instructBox) {
        ...
        instructBox.add(new JLabel("    a yellow piece if he is green,", SwingConstants.LEFT));
        instructBox.add(new JLabel("    a greend piece if he is red, ", SwingConstants.LEFT));
        instructBox.add(new JLabel("    a red piece if he is yellow.", SwingConstants.LEFT));
